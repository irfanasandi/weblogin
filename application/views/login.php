        ...
        <div class="col-sm-10 col-sm-offset-1">
          <div class="login-container">
            <div class="center">
              <br /><br /><br /><br />
              <h1>
                <span class="white" id="id-text2"><i class="ace-icon fa fa-exchange"></i></span>
                <span class="white" id="id-text2">Smart Stock System</span>
              </h1>
                      ...
                      <fieldset>
                        <label class="block clearfix">
                          <span class="block input-icon input-icon-right">
                            <input id="nik" name="nik" type="text" class="form-control" placeholder="Input NIK" required="required" />
